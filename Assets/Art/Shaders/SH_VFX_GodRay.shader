...
Shader "SH_VFX_GodRay"
{
	Properties
	{
		...
		_AlphaFadeEnd("Alpha Fade End", Float) = 600
		_AlphaFadeStart("Alpha Fade Start", Float) = 500
	...
	SubShader
	{
		...
		uniform float _AlphaFadeEnd;
		uniform float _AlphaFadeStart;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = 1;
			float temp_output_8_0 = ( _AlphaFadeEnd + _ProjectionParams.y );
			float2 uv_AlphaTexture = i.uv_texcoord * _AlphaTexture_ST.xy + _AlphaTexture_ST.zw;
			clip( lerp(1.0,( ( ( i.eyeDepth + -temp_output_8_0 ) / ( _AlphaFadeStart - temp_output_8_0 ) ) - tex2D( _AlphaTexture, uv_AlphaTexture ).r ),_Usealphatexture) - _Cutoff );
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-1883.892,541.5589;Float;False;Property;_AlphaFadeEnd;Alpha Fade End;3;0;Create;True;600;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-1436.025,508.143;Float;False;Property;_AlphaFadeStart;Alpha Fade Start;4;0;Create;True;500;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1;-616.356,-259.6853;Float;False;Property;_PlayerColor;Player Color;2;0;Create;True;0,0,0,0;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
